        ...
        return (
            <div>
                ...
                <div>
                    ...
                    <br /><br />
                    <a-button type="primary" size={this.size}>Primary</a-button>
                    <a-button size={this.size}>Normal</a-button>
                    <a-button type="dashed" size={this.size}>Dashed</a-button>
                    <a-button type="danger" size={this.size}>Danger</a-button>
                    <a-button type="link" size={this.size}>Link</a-button>
                    <br />
                    <a-button type="primary" shape="circle" icon="download" size={this.size} />
                    <a-button type="primary" shape="round" icon="download" size={this.size}>Download</a-button>
                    <a-button type="primary" icon="download" size={this.size}>Download</a-button>
                    <br />
